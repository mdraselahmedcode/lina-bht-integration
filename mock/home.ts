...
export const MOCK_INSIGHTS: InsightArticle[] = [
  ...
  },
  {
    ...
    description: 'Vitamin C rich foods like oranges and bell peppers can boost collagen production.',
    icon: 'skin_nutrition',
    actionText: 'Learn More',
  },
];
...
export const MOCK_QUICK_ACTIONS: QuickAction[] = [
  { id: 'scan_skin', title: 'Scan Skin', icon: 'scan_skin' },
  { id: 'scan_product', title: 'Scan Product', icon: 'scan_product' },
  { id: 'my_routine', title: 'My Routine', icon: 'routine' },
  { id: 'ai_assistant', title: 'AI Assistant', icon: 'ai_assistant' },
];
