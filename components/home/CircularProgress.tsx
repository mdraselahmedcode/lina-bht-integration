...
// components/home/CircularProgress.tsx
import React from 'react';
import { View, Text } from 'react-native';
import Svg, { Circle } from 'react-native-svg';
  ...
  return (
    <View style={{ width: size, height: size }}>
      ...
      <View
        ...
        <View className="flex items-center justify-center">
          <Text style={{ fontFamily: 'Outfit-SemiBold', fontSize: size * 0.25 }}>{progress}</Text>
          <Text style={{ fontFamily: 'Outfit-Regular', fontSize: size * 0.15 }}>Score</Text>
        </View>
      </View>
    </View>
  );
